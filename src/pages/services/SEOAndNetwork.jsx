...
import { FaSearch, FaNetworkWired, FaShieldAlt, FaCogs, FaRocket } from "react-icons/fa";
import { motion } from "framer-motion";
import { useNavigate, useLocation } from "react-router-dom";

import whyImg from "../../assets/services/seo.jpg";
import offerImg from "../../assets/services/seo-network-offer.jpg";

const faqs = [
  { q: "What are SEO & Network services?", a: "We provide search engine optimization and network setup, management, and security solutions." },
  { q: "Can you improve our website ranking?", a: "Yes, our SEO strategies boost visibility, traffic, and conversions." },
  { q: "Do you secure networks?", a: "Absolutely, with firewalls, VPNs, and monitoring for safe operations." },
  { q: "Do you support remote teams?", a: "Yes, we provide secure remote access and network management." },
];

export default function SEOAndNetwork() {
  ...
  const whyChooseUs = [
    { icon: FaSearch, title: "SEO Optimization", text: "Increase website visibility and drive high-quality traffic." },
    { icon: FaNetworkWired, title: "Reliable Networks", text: "Stable networks for smooth business operations." },
    { icon: FaShieldAlt, title: "Security", text: "Secure infrastructure with VPNs and firewalls." },
    { icon: FaCogs, title: "Performance & Scalability", text: "Optimized systems that grow with your business." },
  ];

  const whatWeOffer = [
    { icon: FaSearch, title: "SEO Services", text: "Keyword research, on-page and off-page SEO for better ranking." },
    { icon: FaNetworkWired, title: "Network Setup", text: "LAN/WAN design, installation, and maintenance." },
    { icon: FaShieldAlt, title: "Network Security", text: "Protect your systems with robust security solutions." },
    { icon: FaCogs, title: "Monitoring & Support", text: "Continuous monitoring and troubleshooting for networks." },
  ];
    ...
    <div className="bg-gray-50 min-h-screen w-full">
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center mb-28">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-red-700 mb-4">SEO & Network Services</h1>
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto"># Grow Your Business Online & Securely</p>
          <p className="mt-6 text-base md:text-lg text-gray-500 max-w-4xl mx-auto">
            From SEO optimization to secure network setup, we provide solutions for digital growth and infrastructure reliability.
          </p>
        </motion.div>
