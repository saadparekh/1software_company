...
export default function Hero() {
  ...
  return (
    <section
      id="hero-section" // ✅ Updated ID for Back-to-Hero scroll
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10 flex flex-col items-center justify-center pt-20">

        {/* Heading with soft pulsing light effect */}
        <motion.h1
