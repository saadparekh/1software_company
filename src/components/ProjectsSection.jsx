  ...
  return (
    <section className="py-28 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        {/* Heading */}
        <h2 className="text-4xl font-bold text-center text-[#a41d24] mb-4">
          Our Projects
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-10 items-center">
          ...
          <div className="space-y-4">
            {projects.map((p, i) => (
              <div
                key={i}
                onClick={() => setActive(i)}
                className={`cursor-pointer p-5 rounded-lg font-semibold transition
                  ${active === i
          ...
          <div>
            ...
            <h3 className="font-bold text-lg mb-4 text-[#1f1f1f]">
              Key Features
            </h3>
